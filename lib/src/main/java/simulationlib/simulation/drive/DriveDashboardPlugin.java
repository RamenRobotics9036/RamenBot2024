 ...
 */
public class DriveDashboardPlugin implements DashPlugInterface<DriveInputState, DriveState> {
    ...
    @Override
    public MultiType[] getDashboardPropertiesFromInputOutput(
            DriveInputState input,
            DriveState output) {
