 ...
 * </p>
 */
public final class SwerveSimConstants {
    ...
    public static final class Can {
        ...
        public static final int frontLeftCanCoder = 40;
        public static final int frontRightCanCoder = 41;
        public static final int backLeftCanCoder = 42;
        public static final int backRightCanCoder = 43;

        public static final int frontLeftDriveMotor = 40;
        public static final int frontLeftTurnMotor = 41;
        public static final int frontRightDriveMotor = 42;
        public static final int frontRightTurnMotor = 43;
        public static final int backLeftDriveMotor = 44;
        public static final int backLeftTurnMotor = 45;
        public static final int backRightDriveMotor = 46;
        public static final int backRightTurnMotor = 47;
    }
    ...
    /**
     * 1 = closed-loop control (using sensor feedback) and 0 = open-loop control (no sensor
     * feedback).
     */
