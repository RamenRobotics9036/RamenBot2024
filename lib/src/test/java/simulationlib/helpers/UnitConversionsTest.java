...
public class UnitConversionsTest {
    ...
    void rotationToSignedDegreesTestZeroRotation() {
        ...
        assertEquals(
                ...
                UnitConversions.rotationToSignedDegrees(rotation),
                0.001);
    }
    ...
    void signedDegreesToRotationTestZeroDegrees() {
        ...
        assertEquals(
                expectedRotation,
                UnitConversions.signedDegreesToRotation(signedDegrees),
                0.001);
    }
    ...
    void clampSignedDegreesTestNegative180() {
        ...
        assertEquals(
                expectedSignedDegrees,
                UnitConversions.clampSignedDegrees(signedDegrees),
                0.001);
    }
