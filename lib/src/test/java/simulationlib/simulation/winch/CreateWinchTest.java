...
public class CreateWinchTest {
    ...
    private WinchSimModel helperCreatingWinchWithParams(
        ...
        WinchParams winchParams = new WinchParams(spoolDiameterMeters,
                new WinchCable(totalStringLenMeters, totalStringLenMeters - lenSpooled,
                        windingOrientation),
                invertMotor);
    ...
    public void initialLenSpooledLessThanTotalStringLenShouldSucceed() {
        helperCreatingWinchWithParams(
                getTestingSpoolDiameter(),
                5,
                4,
    ...
    public void queryingStringLenExtendedShouldReturnCorrectValueWhenStringOnBack() {
        ...
        WinchSimModel tempWinchSimulation = helperCreatingWinchWithParams(
                getTestingSpoolDiameter(),
                totalStringLen,
                stringLenSpooled,
                stringOrientation,
