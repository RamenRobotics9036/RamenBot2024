...
public class ArmSimModelTest {
    ...
    private boolean getIsStringOrArmBroken(
            SimManager<Double, ArmAngleState> armAngleManager,
            SimManager<Double, Double> armSimManager) {
    ...
    private SimManagersType createDefaultArmHelper(
        ...
        WinchParams winchParams = new WinchParams(m_winchSpoolDiameterMeters,
                new WinchCable(m_winchTotalStringLenMeters,
                        m_winchTotalStringLenMeters - winchInitialLenSpooled,
        ...
        Pair<SimManager<Double, Double>, RamenArmSimLogic> createResult = RamenArmSimLogic
                .createRamenArmSimulation(
                        null,
                        desiredArmAngleSupplier,
                        m_winchAbsoluteEncoderSim,
                        m_defaultArmParams,
                        UnitConversions
                                .rotationToSignedDegrees(grabberLimitRotations - offsetRotations),
                        true);
    ...
    public void createArmSimulationShouldSucceed() {
        ...
        SimManagersType simManagers = createDefaultArmHelper(
                staticWinchInputSupplier,
                tempArmAngleState,
        ...
        assertTrue(
                !getIsStringOrArmBroken(tempAngleSimManager, tempArmSimManager)
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            ...
            Pair<SimManager<Double, Double>, RamenArmSimLogic> createResult = RamenArmSimLogic
                    .createRamenArmSimulation(
                            ...
                            m_winchAbsoluteEncoderSim,
                            m_defaultArmParams,
                            UnitConversions.rotationToSignedDegrees(
                                    grabberLimitRotations - offsetRotations),
                            true);
    ...
    private void moveArmWithGrabberOpenHelper(
            double initialDegreesAboveBreakPoint,
        ...
        double initialPosSignedDegrees = UnitConversions
                .rotationToSignedDegrees(m_defaultGrabberBreaksRotations)
                + initialDegreesAboveBreakPoint;
        double winchInitialLenSpooled = m_winchTotalStringLenMeters
                - m_pivotMechanism
                        .calcAndValidateStringLengthForSignedDegrees(initialPosSignedDegrees);
        ...
        double winchTargetLenSpooled = m_winchTotalStringLenMeters
                - m_pivotMechanism
                        .calcAndValidateStringLengthForSignedDegrees(targetPosSignedDegrees);
        ...
        assertTrue(
                getIsStringOrArmBroken(
                        tempAngleSimManager,
                        tempArmSimManager) == expectedIsArmBroken);
    ...
    private void createWithDegreeArmHelper(
            double backArmAbovePivot,
