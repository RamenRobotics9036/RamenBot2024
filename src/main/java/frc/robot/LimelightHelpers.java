...
public class LimelightHelpers {
    ...
    public static class LimelightTargetRetro {
        ...
        @JsonProperty("t6r_ts")
        private double[] m_robotPoseTargetSpace;
        ...
        public Pose3d getM_cameraPoseTargetSpace() {
            return toPose3D(m_cameraPoseTargetSpace);
        }

        public Pose3d getM_robotPoseFieldSpace() {
            return toPose3D(m_robotPoseFieldSpace);
        }

        public Pose3d getM_robotPoseTargetSpace() {
            return toPose3D(m_robotPoseTargetSpace);
        }

        public Pose3d getM_targetPoseCameraSpace() {
            return toPose3D(m_targetPoseCameraSpace);
        }

        public Pose3d getM_targetPoseRobotSpace() {
            return toPose3D(m_targetPoseRobotSpace);
        }

        public Pose2d getCameraPose_TargetSpace2D() {
            return toPose2D(m_cameraPoseTargetSpace);
        }

        public Pose2d getRobotPose_FieldSpace2D() {
            return toPose2D(m_robotPoseFieldSpace);
        }

        public Pose2d getRobotPose_TargetSpace2D() {
            return toPose2D(m_robotPoseTargetSpace);
        }

        public Pose2d getTargetPose_CameraSpace2D() {
            return toPose2D(m_targetPoseCameraSpace);
        }

        public Pose2d getTargetPose_RobotSpace2D() {
            return toPose2D(m_targetPoseRobotSpace);
        }
    ...
    public static class LimelightResults {
        ...
        public LimelightResults() {
            m_targetingResults = new Results();
        }
    }
