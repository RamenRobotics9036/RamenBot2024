 ...
 */
public class PopulateSimShuffleboard {
    private final DefaultSimLayout m_defaultLayout;
     ...
     * Constructor.
     */
    public PopulateSimShuffleboard(
            ShuffleboardHelpers helpers,
            DefaultSimLayout defaultLayout,
            ShuffleboardTab tab) {
    ...
    private void addHeadingWidget(
        ...
        m_tab.addDouble(title, supplier).withWidget(BuiltInWidgets.kGyro).withPosition(pos.x, pos.y)
                ...
                .withProperties(Map.of("Starting angle", startingAngle));
    }
     ...
     */
    private void addBooleanWidget(
            String title,
            String layoutId,
            String dashItemKey,
            boolean invertBoolValue) {

        BooleanSupplier supplier = constructSupplier(
    ...
    private void addStringWidget(String title, String layoutId, String dashItemKey) {
        ...
        m_tab.addString(title, supplier).withWidget(BuiltInWidgets.kTextView)
    ...
    private void addDoubleAsTextWidget(String title, String layoutId, String dashItemKey) {
        ...
        m_tab.addDouble(title, supplier).withWidget(BuiltInWidgets.kTextView)
                .withPosition(pos.x, pos.y)
                .withSize(pos.width, pos.height);
    }
    ...
    public void addMacros(ArmSystem armSystem) {
        ...
        // Shuffleboard.getTab("Simulation").add("Arm Middle node", new
        // ArmToMiddleNodeCone(armSystem))
